...
const DEFAULT_ITEMS = [
  { image: assets.Neo.src || assets.Neo, label: 'Canyon'},
  { image: assets.Rider.src || assets.Rider, label: 'Ridgeline'},
  { image: assets.MineCraft.src || assets.MineCraft, label: 'Falls'},
  { image: assets.CameraMan.src || assets.CameraMan, label: 'Harbour'},
  { image: assets.Where.src || assets.Where, label: 'Skyline'}
];
